(function () {
    ...
    localStorage.setItem("basicBotsettings", JSON.stringify({
      ...
      intervalMessages: ["#GiveiTagMinutes","Welcome to the Oceanic Tagpro plug.dj! Find us at http://www.reddit.com/r/OceanicTagpro", "Play Now! http://tagpro-diameter.koalabeast.com"],
      messageInterval: 2,
      songstats: false,
      commandLiteral: "!",
      blacklists: {
