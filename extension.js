(function () {
    ...
    localStorage.setItem("basicBotsettings", JSON.stringify({
      ...
      skipPosition: 1,
      skipReasons: [
      ["theme", "This song does not fit today's room theme. "],
      ["op", "This song is being played too much. "],
      ...
      motdEnabled: true,
      motdInterval: 2,
      motd: "STAFF - Please update me to today's theme!",
      filterChat: true,
      ...
      intervalMessages: ["#GiveiTagMinutes","Welcome to the Oceanic Tagpro plug.dj! Find us at http://www.reddit.com/r/OceanicTagpro", "Play Now! http://tagpro-diameter.koalabeast.com", "!motd"],
      messageInterval: 2,
      songstats: false,
      commandLiteral: "!",
      blacklists: {
